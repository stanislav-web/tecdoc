...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnLanguageCompat( oLanguage )
		{
			...
			if ( !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
				oDefaults.sEmptyTable === "В таблице нет записей" )
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Показано _START_ - _END_ строк из _TOTAL_",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(отображено из _MAX_ элементов)",
			 ...
			 *    } );
			 */
			"sProcessing": "Подождите пожалуйста...",
